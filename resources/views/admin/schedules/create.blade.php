...
@section('page-title', 'Create Schedule Session')
    ...
    <form action="{{ route('admin.schedules.store') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="subject" id="subject" required value="{{ old('subject') }}" placeholder="Ex: Mathematics, Cyber Security"
