    ...
    <form action="{{ route('admin.groups.store') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="number" name="max_capacity" id="max_capacity" min="1" required value="{{ old('max_capacity') }}"
                       class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">{{ old('description') }}</textarea>
