...
<form method="POST" action="{{ route('admin.employees.update', $employee) }}"
    ...
    <div class="flex items-center gap-5">
        <div id="photo-preview"
             class="w-20 h-20 rounded-full bg-indigo-100 text-indigo-700 font-bold text-2xl
                    flex items-center justify-center shrink-0 overflow-hidden border-2
    ...
    <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400">Auto-regenerated on save</p>
